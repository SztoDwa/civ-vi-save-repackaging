...
| 0x04 | ASCII string                     | 2 words + ? bytes total: <br> * 3 bytes - 24-bit integer N <br> * 1 byte - always 0x21 <br> * 1 word as 32-bit integer M - no. bytes per character; always = 1 <br> * N\*M = N\*1 = N bytes <br> <br> **IMPORTANT NOTE:** Empty strings are sometimes represented by replacing the first two words with `00 00 00 20 00 00 00 00`. In such case there are no content bytes after these words.                                                                                                                                                                                                                             |
